...
public class LLRootTemplateAnnotation_Constraints extends BaseConstraintsDescriptor {
  public LLRootTemplateAnnotation_Constraints() {
    super(CONCEPTS.LLRootTemplateAnnotation$_J);
  }

  @Override
  protected Map<SReferenceLink, ReferenceConstraintsDescriptor> getSpecifiedReferences() {
    BaseReferenceConstraintsDescriptor d0 = new BaseReferenceConstraintsDescriptor(LINKS.forType$3Tow, this) {
      @Override
      ...
      public ReferenceScopeProvider getScopeProvider() {
        return new BaseScopeProvider() {
          ...
          public SNodeReference getSearchScopeValidatorNode() {
            return breakingNode_fihhup_a0a0a0a0a1a0a0a0c;
          }
          @Override
  ...
  private static final SNodePointer breakingNode_fihhup_a0a0a0a0a1a0a0a0c = new SNodePointer("r:aa88a3b8-c90e-4870-9ff0-fbabf67ef8ef(languagelab.mps.lang.adaptedGenerator.constraints)", "3847567280518652336");
