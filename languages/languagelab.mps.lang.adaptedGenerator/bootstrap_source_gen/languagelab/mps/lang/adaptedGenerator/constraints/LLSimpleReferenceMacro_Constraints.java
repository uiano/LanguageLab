...
public class LLSimpleReferenceMacro_Constraints extends BaseConstraintsDescriptor {
  public LLSimpleReferenceMacro_Constraints() {
    super(CONCEPTS.LLSimpleReferenceMacro$ki);
  }

  @Override
  protected Map<SReferenceLink, ReferenceConstraintsDescriptor> getSpecifiedReferences() {
    BaseReferenceConstraintsDescriptor d0 = new BaseReferenceConstraintsDescriptor(LINKS.myRef$41nY, this) {
      @Override
      ...
      public ReferenceScopeProvider getScopeProvider() {
        return new BaseScopeProvider() {
          ...
          public SNodeReference getSearchScopeValidatorNode() {
            return breakingNode_2jkzgl_a0a0a0a0a1a0a0a0c;
          }
          @Override
            ...
            for (SNode currentNode = _context.getContextNode(); currentNode != null; currentNode = SNodeOperations.getParent(currentNode)) {
              if (AttributeOperations.getAttributeList(currentNode, new IAttributeDescriptor.NodeAttribute(CONCEPTS.NodeMacro$Je)) != null) {
                ...
                if (Sequence.fromIterable(seq).isNotEmpty()) {
                  SReference tempRoot = SLinkOperations.getTarget(Sequence.fromIterable(seq).first(), LINKS.loopElements$Aicw).getReference(SStuffHelper.REFERENCE_TYPE);
  ...
  private static final SNodePointer breakingNode_2jkzgl_a0a0a0a0a1a0a0a0c = new SNodePointer("r:aa88a3b8-c90e-4870-9ff0-fbabf67ef8ef(languagelab.mps.lang.adaptedGenerator.constraints)", "8714292893663263187");
