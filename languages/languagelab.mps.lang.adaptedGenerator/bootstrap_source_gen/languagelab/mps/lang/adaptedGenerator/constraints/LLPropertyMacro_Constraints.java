...
public class LLPropertyMacro_Constraints extends BaseConstraintsDescriptor {
  private static final Logger LOG = LogManager.getLogger(LLPropertyMacro_Constraints.class);
  public LLPropertyMacro_Constraints() {
    super(CONCEPTS.LLPropertyMacro$gk);
  }

  @Override
  protected Map<SReferenceLink, ReferenceConstraintsDescriptor> getSpecifiedReferences() {
    BaseReferenceConstraintsDescriptor d0 = new BaseReferenceConstraintsDescriptor(LINKS.myAttr$3MQY, this) {
      @Override
      ...
      public ReferenceScopeProvider getScopeProvider() {
        return new BaseScopeProvider() {
          ...
          public SNodeReference getSearchScopeValidatorNode() {
            return breakingNode_ogl95j_a0a0a0a0a1a0a0a0c;
          }
          @Override
          public Scope createScope(final ReferenceConstraintsContext _context) {
            LoggingRuntime.logMsgView(Level.WARN, "myAttr executed", LLPropertyMacro_Constraints.class, null, null);
            ...
            while (myType != null) {
              LoggingRuntime.logMsgView(Level.WARN, "check in " + SPropertyOperations.getString(SNodeOperations.cast(myType, CONCEPTS.INamedConcept$nV), PROPS.name$tAp1), LLPropertyMacro_Constraints.class, null, null);
  ...
  private static final SNodePointer breakingNode_ogl95j_a0a0a0a0a1a0a0a0c = new SNodePointer("r:aa88a3b8-c90e-4870-9ff0-fbabf67ef8ef(languagelab.mps.lang.adaptedGenerator.constraints)", "8714292893663434464");
