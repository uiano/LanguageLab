...
public class LLCopySourceListMacro_Constraints extends BaseConstraintsDescriptor {
  public LLCopySourceListMacro_Constraints() {
    super(CONCEPTS.LLCopySourceListMacro$EN);
  }

  @Override
  protected Map<SReferenceLink, ReferenceConstraintsDescriptor> getSpecifiedReferences() {
    BaseReferenceConstraintsDescriptor d0 = new BaseReferenceConstraintsDescriptor(LINKS.myAggregate$a61a, this) {
      @Override
      ...
      public ReferenceScopeProvider getScopeProvider() {
        return new BaseScopeProvider() {
          ...
          public SNodeReference getSearchScopeValidatorNode() {
            return breakingNode_s5hvwa_a0a0a0a0a1a0a0a0c;
          }
          @Override
  ...
  private static final SNodePointer breakingNode_s5hvwa_a0a0a0a0a1a0a0a0c = new SNodePointer("r:aa88a3b8-c90e-4870-9ff0-fbabf67ef8ef(languagelab.mps.lang.adaptedGenerator.constraints)", "8714292893663196797");
