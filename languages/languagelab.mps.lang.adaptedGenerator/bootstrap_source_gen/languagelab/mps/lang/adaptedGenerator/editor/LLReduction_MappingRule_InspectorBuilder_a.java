...
/*package*/ class LLReduction_MappingRule_InspectorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public LLReduction_MappingRule_InspectorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_sqcr7r_0");
  ...
  private EditorCell createConstant_0() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, "reduction rule");
    editorCell.setCellId("Constant_sqcr7r_0");
    Style style = new StyleImpl();
    style.set(StyleAttributes.SELECTABLE, false);
  ...
  private EditorCell createConstant_1() {
    ...
    editorCell.setCellId("Constant_sqcr7r_1");
    Style style = new StyleImpl();
    style.set(StyleAttributes.SELECTABLE, false);
    editorCell.getStyle().putAll(style);
    editorCell.setDefaultText("");
