...
/*package*/ class LLSpecialReferenceMacro_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public LLSpecialReferenceMacro_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_yaj9zt_a");
  ...
  private EditorCell createConstant_0() {
    ...
    editorCell.setCellId("Constant_yaj9zt_a0");
  ...
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.myRef$47Uu;
    ...
    provider.setNoTargetText("<no myRef>");
    EditorCell editorCell = provider.createCell();

    if (editorCell.getSRole() == null) {
      editorCell.setReferenceCell(true);
      editorCell.setSRole(LINKS.myRef$47Uu);
    }
  ...
  private EditorCell createConstant_1() {
    ...
    editorCell.setCellId("Constant_yaj9zt_c0");
    editorCell.setDefaultText("");
    return editorCell;
  }
