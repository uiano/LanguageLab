...
/*package*/ class LLRoot_MappingRule_InspectorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public LLRoot_MappingRule_InspectorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_rznpvj_0");
  ...
  private EditorCell createConstant_0() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, "ll root mapping rule");
    editorCell.setCellId("Constant_rznpvj_0");
    Style style = new StyleImpl();
    style.set(StyleAttributes.SELECTABLE, false);
  ...
  private EditorCell createConstant_1() {
    ...
    editorCell.setCellId("Constant_rznpvj_1");
    Style style = new StyleImpl();
    style.set(StyleAttributes.SELECTABLE, false);
    editorCell.getStyle().putAll(style);
    editorCell.setDefaultText("");
