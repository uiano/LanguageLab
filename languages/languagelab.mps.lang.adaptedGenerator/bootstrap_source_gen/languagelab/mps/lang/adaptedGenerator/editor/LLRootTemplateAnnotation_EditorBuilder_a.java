...
/*package*/ class LLRootTemplateAnnotation_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public LLRootTemplateAnnotation_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_g7vy40_a");
  ...
  private EditorCell createCollection_1() {
    EditorCell_Collection editorCell = new EditorCell_Collection(getEditorContext(), myNode, new CellLayout_Vertical());
    editorCell.setCellId("Collection_g7vy40_a0");
    Style style = new StyleImpl();
  ...
  private EditorCell createConstant_0() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, "ll root template");
    editorCell.setCellId("Constant_g7vy40_a0a");
    Style style = new StyleImpl();
  ...
  private EditorCell createCollection_2() {
    ...
    editorCell.setCellId("Collection_g7vy40_b0a");
    Style style = new StyleImpl();
    style.set(StyleAttributes.SELECTABLE, false);
    editorCell.getStyle().putAll(style);
  ...
  private EditorCell createConstant_1() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, "input type");
    editorCell.setCellId("Constant_g7vy40_a1a0");
    Style style = new StyleImpl();
    new GeneratorKeyWordStyleClass(getEditorContext(), getNode()).apply(style, editorCell);
    style.set(StyleAttributes.SELECTABLE, false);
    editorCell.getStyle().putAll(style);
  ...
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.forType$3Tow;
    ...
    if (editorCell.getSRole() == null) {
      ...
      editorCell.setSRole(LINKS.forType$3Tow);
    }
  ...
  private EditorCell createConstant_2() {
    ...
    editorCell.setCellId("Constant_g7vy40_c0a");
    Style style = new StyleImpl();
    style.set(StyleAttributes.SELECTABLE, false);
    editorCell.getStyle().putAll(style);
    editorCell.setDefaultText("");
