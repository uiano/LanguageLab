...
/*package*/ class LLCopySourceListMacro_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public LLCopySourceListMacro_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_q6x087_a");
  ...
  private EditorCell createConstant_0() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, "$COPY_SRCL$(ll:");
    editorCell.setCellId("Constant_q6x087_a0");
  ...
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.myAggregate$a61a;
    SReferenceCellProvider provider = new SReferenceCellProvider(getNode(), referenceLink, getEditorContext()) {
      protected EditorCell createReferenceCell(final SNode targetNode) {
        ...
        }, targetNode, LINKS.myAggregate$a61a);
    ...
    provider.setNoTargetText("<no myAggregate>");
    EditorCell editorCell = provider.createCell();

    if (editorCell.getSRole() == null) {
      editorCell.setReferenceCell(true);
      editorCell.setSRole(LINKS.myAggregate$a61a);
    }
  ...
  private EditorCell createConstant_1() {
    ...
    editorCell.setCellId("Constant_q6x087_c0");
    editorCell.setDefaultText("");
    return editorCell;
  }
