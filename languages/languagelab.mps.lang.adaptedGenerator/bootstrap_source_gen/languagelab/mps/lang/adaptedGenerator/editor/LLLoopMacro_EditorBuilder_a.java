...
/*package*/ class LLLoopMacro_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public LLLoopMacro_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_vsfroi_a");
  ...
  private EditorCell createConstant_0() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, "$LOOP$(ll:");
    editorCell.setCellId("Constant_vsfroi_a0");
  ...
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.loopElements$Aicw;
    SReferenceCellProvider provider = new SReferenceCellProvider(getNode(), referenceLink, getEditorContext()) {
      protected EditorCell createReferenceCell(final SNode targetNode) {
        ...
        }, targetNode, LINKS.loopElements$Aicw);
    ...
    provider.setNoTargetText("<no loopElements>");
    EditorCell editorCell = provider.createCell();

    if (editorCell.getSRole() == null) {
      editorCell.setReferenceCell(true);
      editorCell.setSRole(LINKS.loopElements$Aicw);
    }
  ...
  private EditorCell createConstant_1() {
    ...
    editorCell.setCellId("Constant_vsfroi_c0");
    editorCell.setDefaultText("");
    return editorCell;
  }
