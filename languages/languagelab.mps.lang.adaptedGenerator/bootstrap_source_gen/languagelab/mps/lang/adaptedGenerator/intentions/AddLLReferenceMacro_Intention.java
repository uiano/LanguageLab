...
public final class AddLLReferenceMacro_Intention extends AbstractIntentionDescriptor implements IntentionFactory {
  private Collection<IntentionExecutable> myCachedExecutable;
  public AddLLReferenceMacro_Intention() {
    super(Kind.NORMAL, false, new SNodePointer("r:39fc6394-a6da-4c8a-a684-b3004357ba4c(languagelab.mps.lang.adaptedGenerator.intentions)", "8714292893666727393"));
  }
  @Override
  public String getPresentation() {
    return "AddLLReferenceMacro";
  }
  @Override
  ...
  /*package*/ final class IntentionImplementation extends AbstractIntentionExecutable {
    ...
    public void execute(final SNode node, final EditorContext editorContext) {
      ...
      SNode referenceMacro = SNodeFactoryOperations.setNewAttribute(referentNode, new IAttributeDescriptor.LinkAttribute(CONCEPTS.ReferenceMacro$nk, ref), CONCEPTS.LLSimpleReferenceMacro$ki);
    ...
    public IntentionDescriptor getDescriptor() {
      return AddLLReferenceMacro_Intention.this;
    }
  }
