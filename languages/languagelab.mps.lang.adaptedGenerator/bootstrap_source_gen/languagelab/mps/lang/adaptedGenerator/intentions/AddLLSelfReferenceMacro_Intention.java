...
public final class AddLLSelfReferenceMacro_Intention extends AbstractIntentionDescriptor implements IntentionFactory {
  private Collection<IntentionExecutable> myCachedExecutable;
  public AddLLSelfReferenceMacro_Intention() {
    super(Kind.NORMAL, false, new SNodePointer("r:39fc6394-a6da-4c8a-a684-b3004357ba4c(languagelab.mps.lang.adaptedGenerator.intentions)", "8714292893666992271"));
  }
  @Override
  public String getPresentation() {
    return "AddLLSelfReferenceMacro";
  }
  @Override
  ...
  /*package*/ final class IntentionImplementation extends AbstractIntentionExecutable {
    ...
    public String getDescription(final SNode node, final EditorContext editorContext) {
      return "Add LL Self Reference Macro";
    }
    @Override
    public void execute(final SNode node, final EditorContext editorContext) {
      ...
      SNode referenceMacro = SNodeFactoryOperations.setNewAttribute(referentNode, new IAttributeDescriptor.LinkAttribute(CONCEPTS.ReferenceMacro$nk, ref), CONCEPTS.LLSelfReferenceMacro$CG);
    ...
    public IntentionDescriptor getDescriptor() {
      return AddLLSelfReferenceMacro_Intention.this;
    }
  }
  ...
  private static final class CONCEPTS {
    ...
    /*package*/ static final SConcept LLSelfReferenceMacro$CG = MetaAdapterFactory.getConcept(0xe0a091b2dc994294L, 0xa6268d2e85598ee6L, 0x3afac1bd2d5b52f5L, "languagelab.mps.lang.adaptedGenerator.structure.LLSelfReferenceMacro");
