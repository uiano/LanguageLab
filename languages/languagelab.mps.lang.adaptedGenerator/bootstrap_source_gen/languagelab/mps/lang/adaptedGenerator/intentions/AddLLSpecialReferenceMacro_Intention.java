...
public final class AddLLSpecialReferenceMacro_Intention extends AbstractIntentionDescriptor implements IntentionFactory {
  private Collection<IntentionExecutable> myCachedExecutable;
  public AddLLSpecialReferenceMacro_Intention() {
    super(Kind.NORMAL, false, new SNodePointer("r:39fc6394-a6da-4c8a-a684-b3004357ba4c(languagelab.mps.lang.adaptedGenerator.intentions)", "8714292893667250818"));
  }
  @Override
  public String getPresentation() {
    return "AddLLSpecialReferenceMacro";
  }
  @Override
  ...
  /*package*/ final class IntentionImplementation extends AbstractIntentionExecutable {
    ...
    public String getDescription(final SNode node, final EditorContext editorContext) {
      return "Add LL Special Reference Macro";
    }
    @Override
    public void execute(final SNode node, final EditorContext editorContext) {
      ...
      SNode referenceMacro = SNodeFactoryOperations.setNewAttribute(referentNode, new IAttributeDescriptor.LinkAttribute(CONCEPTS.ReferenceMacro$nk, ref), CONCEPTS.LLSpecialReferenceMacro$DH);
      LinkAttribute__BehaviorDescriptor.setLink_id6Gg5KlvuxxF.invoke(referenceMacro, ref);
      SNodeFactoryOperations.setNewChild(referenceMacro, LINKS.referentFunction$ABIo, null);
      SNode dummyReturn = SLinkOperations.addNewChild(SLinkOperations.getTarget(SLinkOperations.getTarget(referenceMacro, LINKS.referentFunction$ABIo), LINKS.body$pTP2), LINKS.statement$WHn8, CONCEPTS.ReturnStatement$SF);
    ...
    public IntentionDescriptor getDescriptor() {
      return AddLLSpecialReferenceMacro_Intention.this;
    }
  }
