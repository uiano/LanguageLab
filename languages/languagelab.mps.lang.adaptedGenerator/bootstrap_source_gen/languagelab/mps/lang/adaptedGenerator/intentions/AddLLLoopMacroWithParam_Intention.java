...
public final class AddLLLoopMacroWithParam_Intention extends AbstractIntentionDescriptor implements IntentionFactory {
  public AddLLLoopMacroWithParam_Intention() {
    super(Kind.NORMAL, false, new SNodePointer("r:39fc6394-a6da-4c8a-a684-b3004357ba4c(languagelab.mps.lang.adaptedGenerator.intentions)", "8714292893665886032"));
  }
  @Override
  public String getPresentation() {
    return "AddLLLoopMacroWithParam";
  }
  @Override
  ...
  /*package*/ final class IntentionImplementation extends AbstractIntentionExecutable implements ParameterizedIntentionExecutable {
    ...
    public String getDescription(final SNode node, final EditorContext editorContext) {
      return "Apply LL LOOP over node." + SPropertyOperations.getString(myParameter, PROPS.name$tAp1);
    }
    @Override
    public void execute(final SNode node, final EditorContext editorContext) {
      SNode nodeMacro = EditingUtil.addNodeMacro(node);
      SNode llLoopMacro = SNodeFactoryOperations.createNewNode(CONCEPTS.LLLoopMacro$C7, null);
      SNodeOperations.replaceWithAnother(nodeMacro, llLoopMacro);
      SLinkOperations.setTarget(llLoopMacro, LINKS.loopElements$Aicw, myParameter);
      // set caret 
      SelectionUtil.selectLabelCellAnSetCaret(editorContext, llLoopMacro, SelectionManager.FIRST_CELL, 1);
    }
    @Override
    public IntentionDescriptor getDescriptor() {
      return AddLLLoopMacroWithParam_Intention.this;
    }
