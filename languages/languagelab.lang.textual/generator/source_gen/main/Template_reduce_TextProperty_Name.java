...
@Generated
public class Template_reduce_TextProperty_Name extends TemplateDeclarationBase implements TemplateDeclaration2 {

  public Template_reduce_TextProperty_Name() {
  }

  public SNodeReference getTemplateNode() {
    return new SNodePointer("r:8f686c14-57a1-42ec-b78f-dc89d09136f4(main@generator)", "485512855557934262");
  }
  ...
  protected FragmentResult applyPart0(@NotNull final TemplateContext context) throws GenerationException {
    ...
    try {
      tnode1.setReference(myAssociationLinks[0], SReference.create(myAssociationLinks[0], tnode1, PersistenceFacade.getInstance().createModelReference("r:00000000-0000-4000-0000-011c89590288(jetbrains.mps.lang.core.structure)"), PersistenceFacade.getInstance().createNodeId("1169194664001")));
    } finally {
    }
