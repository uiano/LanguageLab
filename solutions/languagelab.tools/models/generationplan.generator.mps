...
<model ref="r:97c017d0-897d-4a61-a925-e521fe0b6b7a(languagelab.tools.generationplan.generator)">
  ...
  <node concept="2VgMpV" id="11DirQ2pk2j">
    <property role="TrG5h" value="LanguageLabGeneratorPlan" />
    <node concept="3uMcMo" id="11DirQ2pq0m" role="2VgMA7">
      <node concept="3uMdn$" id="11DirQ2pq0r" role="3uOsAP">
        <node concept="20RdaH" id="11DirQ2pq0s" role="3uMdmt">
    ...
    <node concept="2VgMA1" id="1412MkkjqEc" role="2VgMA7">
      <node concept="3ps6a7" id="1412MkkjqEp" role="3ps6aC">
        <ref role="3ps6dU" to="uczb:1412MkkjqCa" resolve="MpsLanguages" />
      </node>
    </node>
    <node concept="1ONwER" id="11DirQ2pq0B" role="2VgMA7">
      <node concept="16rNan" id="11DirQ2pq0J" role="1ONSkY">
        <property role="16rNbL" value="Here we should include generator plan for generator aspect in MPS, but such plan is not available yet..." />
      </node>
    </node>
  </node>
</model>
